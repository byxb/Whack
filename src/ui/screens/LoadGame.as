...
package ui.screens
{
	...
	/**
	 * Creates a load game screen.  
	 * @author Johnny Nguyen - Johnny [at] byxb [dot] com
	 */
	public class LoadGame extends Sprite
	{	
		private const _LOAD_GAME_BTN_TEXTURE:String="";
		
		private var _loadGameButtons:Vector.<LoadGameButton>=new <LoadGameButton>();
		/**
		 * Creates a load game screen.
		 */
		...
		private function addLoadGameButtons():void 
		{
			for (var i:uint=0; i<3; i++)
			{
				
				_loadGameButton[i]=new LoadGameButton(
			}
		}
	}
}