...
package world.items.zones
{
	...
	/**
	 * A zone for the area above ground
	 * @author Justin Church  - Justin [at] byxb [dot] com 
	 * 
	 */
	public class NearGroundZone extends ItemZone
	{
		/**
		 * A zone with low-value above ground items.
		 */
		public function NearGroundZone()
		{
			super();
			_top=-10000;
			_density=.05;
			addItemChance(Pepper, 1)
			addItemChance(Watch, 1)
			addItemChance(Ring, 2)
			addItemChance(Hat, 1, true)
		}
	}
}
