...
package world.events
{
	...
	/**
	 * The MoleSurfaceEvent is fired when the mole breaks the surface of the ground either going into the ground 
	 * or leaving the ground.
	 * @author Justin Church  - Justin [at] byxb [dot] com 
	 * 
	 */
	public class MoleSurfaceEvent extends Event
	{
		/**
		 * The event type
		 * @default 
		 */
		public static var MOLE_SURFACE:String="moleSurface";
		
		/**
		 * Indicates if the mole is now above the surface (the new state).
		 * @default 
		 */
		public var isAbove:Boolean;
		
		/**
		 * A Vector3D of the speed and direction the mole is moving.
		 * @default 
		 */
		 ...
		 * The MoleSurfaceEvent is fired when the mole breaks the surface of the ground either going into the ground 
	 	 * or leaving the ground.
		 * @param isAbove Indicates if the mole is now above the surface (the new state).
		 * @param velocity A Vector3D of the speed and direction the mole is moving.
		 * @param bubbles
		 */
		public function MoleSurfaceEvent(isAbove:Boolean, velocity:Vector3D, bubbles:Boolean=false)
		{
			this.isAbove=isAbove;
			this.velocity=velocity;
			super(MOLE_SURFACE, bubbles);
		}
	}
}
