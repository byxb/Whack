...
package store.events
{
	...
	/**
	 * This event is fired when the store is closed.
	 * @author Johnny Nguyen - Johnny [at] byxb [dot] com 
	 */
	public class StoreCloseEvent extends Event
	{
		public static const STORE_CLOSE:String = "storeClose";
		
		public function StoreCloseEvent(type:String, bubbles:Boolean=false)
		{
			super(type, bubbles);
		}
	}
